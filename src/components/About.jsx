...
const About = () => {
  return (
    <div className="bg-[#263238] w-2/3 mx-auto text-center py-20 px-10 rounded-xl">
      <h3 className="text-xl w-2/3 mx-auto font-bold  text-[#999]">
        I’m Lekside, a SaaS Animator with 05 years experience sketching,
        building & coaching. I love fun SaaS Animation video in both 2d and 3d,
        collaboration and making helpful products that connect people.
      </h3>
      <hr className="text-[#333] m-10" />
      <p className="text-xs text-[#ccc] mb-2 underline">
        Facebook:
        <a
          href="https://web.facebook.com/olamilekanolakunle.olakunle"
          target="_blank"
        >
          Olamilekan Olakunle Olakunle
        </a>
      </p>
      <p className="text-xs text-[#ccc] mb-2 underline">
        Instagram:
